...
public class Test {
    public static void main(String args[]){
        int n = 6;
        Job arr[] = new Job[n];
        arr[0] = new Job(1,3,53,"Job 1");
        arr[1] = new Job(2,5,62,"Job 2");
        arr[2] = new Job(4,6,55,"Job 3");
        arr[3] = new Job(6,7,48,"Job 4");
        arr[4] = new Job(5,8,110,"Job 5");
        arr[5] = new Job(7,9,21,"Job 6");
